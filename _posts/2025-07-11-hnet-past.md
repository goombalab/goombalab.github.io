...
date: 2025-07-10
featured: false
thumbnail: assets/img/2025-07-11-hnet/tuning.png
...
Ultimately, I guess that DPT attempted to tackle this problem somewhat prematurely and important ideas weren't available yet (for example, the most popular [Switch Transformer](https://arxiv.org/abs/2101.03961) MoE method <d-cite key="fedus2022switch"></d-cite>  was pretty new and perhaps not as established yet; neither was Mamba, which we found to be quite important).
