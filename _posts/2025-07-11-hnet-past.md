...
I've been fortunate enough to be able to work with my student [Sukjun](https://sukjunhwang.github.io/) who made the technical breakthroughs behind this model, solving (or at least making serious progress towards) what I consider to be a very difficult but foundational problem for deep learning.
...
But in the event that the actual token that appears is a different word $w'$,
...
I haven't been able to run experiments personally in a while, and it was like watching an artist work to see Sukjun improve the architecture steadily over time with multiple creative and essential ideas -- if it isn't clear, he has by far the best intuition for everything related to H-Nets.
...
I also actually believe that **H-Nets will significantly shift the scaling law curve**.
